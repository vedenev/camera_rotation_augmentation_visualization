...
INPUT_IMAGE = "images/frame_indoor_2022_05_04_horizontal.png"
INPUT_IMAGE = "images/frame_indoor_2022_05_04_horizontal_2.png"
...
a_x_deg_all = np.linspace(-25, 25, 15)
a_x_deg_all = np.concatenate((a_x_deg_all, a_x_deg_all[::-1]))
a_y_deg_all = np.linspace(-15, 15, 5)
a_y_deg_all = np.concatenate((a_y_deg_all, a_y_deg_all[::-1]))

is_first_frame = True
for a_y_deg in a_y_deg_all:
    for a_x_deg in a_x_deg_all:
